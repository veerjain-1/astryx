  ...
  render: args => {
    ...
    return <div style={{
      display: 'flex'
        ...
        <Typeahead {...args} searchSource={fruitSource} value={value} onChange={setValue} />
      </div>;
  },
  args: {
    label: 'Fruit',
...
}`,...h.parameters?.docs?.source},description:{story:`A selected value is shown as a token, and the field keeps the width it had
...
floor with \`--typeahead-min-width\` on the \`typeahead\` theme target.`,...h.parameters?.docs?.description}}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  ...Default,
  args: {
    ...Default.args,
    isRequired: true
...
}`,...k.parameters?.docs?.source}}},A=[`Default`,`WithBootstrap`,`WithSelectedValue`,`Required`,`Optional`,`WithDescription`,`WithError`,`WithWarning`,`WithSuccess`,`Disabled`,`DisabledWithMessage`,`NoClear`,`LimitedResults`,`MinQueryLength`,`SizeVariants`,`WithStartIcon`,`StatusVariantComparison`]}))();export{p as Default,S as Disabled,C as DisabledWithMessage,T as LimitedResults,E as MinQueryLength,w as NoClear,_ as Optional,g as Required,D as SizeVariants,k as StatusVariantComparison,m as WithBootstrap,v as WithDescription,y as WithError,h as WithSelectedValue,O as WithStartIcon,x as WithSuccess,b as WithWarning,A as __namedExportsOrder,f as default};