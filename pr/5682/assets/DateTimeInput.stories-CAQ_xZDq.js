import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{s as i}from"./useTheme-Bd7l0lTu.js";import{t as a,x as o}from"./theme-BMr4yCTX.js";import{Cn as s,wn as c}from"./iframe-DBKuvS9N.js";var l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F;e((()=>{l=t(n()),s(),a(),u=r(),d={title:`Core/DateTimeInput`,component:c,tags:[`autodocs`],parameters:{docs:{description:{component:`A date-time field that fits the pointer it is used with. On a mouse or trackpad it renders the existing side-by-side date and time inputs: the date half opens a calendar popover, and the time half accepts typed entry plus optional preset times.
