...
`],placeholder:`Paste a comma- or semicolon-separated list...`}),(0,d.jsxs)(`p`,{style:{marginTop:8,fontSize:14,opacity:.72},children:[t.length,` added. Splits on comma, semicolon, or newline.`]})]})},args:{label:`Emails`},name:`Creatable — custom delimiters`},L={render:e=>{let[t]=(0,u.useState)([f[0],f[1]]);return(0,d.jsx)(o,{...e,searchSource:p,value:t,onChange:()=>{}})},args:{label:`Team Members`,isDisabled:!0,disabledMessage:`You need edit access to change members`}},R={render:()=>{let[e,t]=(0,u.useState)([]),[n,r]=(0,u.useState)([]);return(0,d.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:24,width:320},children:[(0,d.jsx)(o,{label:`Attached (default)`,searchSource:p,value:e,onChange:e=>t(e),status:{type:`error`,message:`Select at least one member`}}),(0,d.jsx)(o,{label:`Detached`,searchSource:p,value:n,onChange:e=>r(e),status:{type:`error`,message:`Select at least one member`},statusVariant:`detached`})]})}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  ...
  render: args => {
    ...
    return <div>
        ...
        setTags(items);
      }} hasCreate placeholder="Type or paste a list of tags..." />
        <p style={{
        marginTop: 8,
        fontSize: 14,
  ...
  render: args => {
    const [value, setValue] = useState<SearchableItem[]>([]);
    return <div>
        <Tokenizer {...args} searchSource={emptySource} value={value} onChange={(items, _change) => {
        setValue(items);
      }} hasCreate delimiters={[]} placeholder='Type e.g. "Smith, John" and press Enter...' />
        <p style={{
        marginTop: 8,
        fontSize: 14,
        opacity: 0.72
...
}`,...R.parameters?.docs?.source}}},z=[`Default`,`WithPreselected`,`WithClear`,`MaxEntries`,`Required`,`WithDescription`,`WithError`,`WithWarning`,`WithSuccess`,`Disabled`,`WithStartIcon`,`WithStartIconAndTokens`,`WithEntriesOnFocus`,`OverflowInline`,`OverflowLayer`,`WithEndContent`,`Creatable`,`SizeVariants`,`CreatableWithSearch`,`CreatableCommaValues`,`CreatableCustomDelimiters`,`DisabledWithMessage`,`StatusVariantComparison`]}))();export{M as Creatable,F as CreatableCommaValues,I as CreatableCustomDelimiters,P as CreatableWithSearch,h as Default,w as Disabled,L as DisabledWithMessage,v as MaxEntries,O as OverflowInline,k as OverflowLayer,y as Required,N as SizeVariants,R as StatusVariantComparison,_ as WithClear,b as WithDescription,A as WithEndContent,D as WithEntriesOnFocus,x as WithError,g as WithPreselected,T as WithStartIcon,E as WithStartIconAndTokens,C as WithSuccess,S as WithWarning,z as __namedExportsOrder,m as default};