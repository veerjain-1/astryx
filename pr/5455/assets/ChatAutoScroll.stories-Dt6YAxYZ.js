import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{t as i}from"./Button-Djh_f1Xl.js";import{t as a}from"./Button-BkZG2xr-.js";import{n as o,t as s}from"./Badge-C2n4rYrU.js";import{i as c,t as l}from"./CodeBlock-k-qVa-cn.js";import{r as u}from"./Heading-CaHx9DQH.js";import{t as d}from"./Text-CfcCRLVq.js";import{Cr as f,Er as p,Nr as m,Ur as h,Vr as g,Yr as _,jr as v,wr as y}from"./iframe-DNYR6K_m.js";var b,x,S,C,w,T,E,D,O;e((()=>{p(),f(),a(),d(),l(),s(),b=t(n()),x=r(),S={title:`Core/ChatAutoScroll`,tags:[`autodocs`],parameters:{layout:`fullscreen`}},C=`Let me analyze this codebase for you. I'll start by looking at the project structure and understanding the architecture.
...
│ (shared observer)   │
└─────────────────────┘`,language:`text`})]})}])},[]),S=(0,b.useCallback)(()=>{clearInterval(a.current),r(!1),s.current=0,t([{id:1,role:`user`,text:`Can you analyze the auto-scroll system and fix the issue with tool calls?`},{id:2,role:`assistant`,text:"Sure, I'll look into the auto-scroll behavior. Let me start by reading the relevant files.\n\nThe scroll system uses `useChatStreamScroll` for spring-based scroll tracking and `useChatNewMessages` for content observation."},{id:3,role:`user`,text:`Great, show me what you find.`}])},[]);return(0,x.jsxs)(`div`,{className:`x1dr59a3 x78zum5 xdt5ytf`,children:[(0,x.jsxs)(`div`,{className:`x78zum5 x167g77z xc7ga6q x4befzd x1a02dak x6s0dn4`,children:[(0,x.jsx)(i,{label:`Stream Text (works ✓)`,variant:`primary`,size:`sm`,onClick:l,isDisabled:n}),(0,x.jsx)(i,{label:`Add Tool Call (may fail ✗)`,variant:`secondary`,size:`sm`,onClick:d}),(0,x.jsx)(i,{label:`Batch Tool Calls (likely fails ✗)`,variant:`secondary`,size:`sm`,onClick:f}),(0,x.jsx)(i,{label:`Add Custom Element (may fail ✗)`,variant:`secondary`,size:`sm`,onClick:p}),(0,x.jsx)(i,{label:`Reset`,variant:`ghost`,size:`sm`,onClick:S}),(0,x.jsx)(`div`,{className:`xvc5jky x78zum5 x6s0dn4 x17d4w8g`,children:(0,x.jsx)(o,{variant:n?`green`:`neutral`,label:n?`Streaming`:`Idle`})})]}),(0,x.jsx)(v,{composer:(0,x.jsx)(_,{onSubmit:()=>{},placeholder:`Observe auto-scroll behavior above...`,isStopShown:n}),children:(0,x.jsx)(h,{children:e.map(e=>(0,x.jsxs)(g,{sender:e.role,children:[e.text&&(0,x.jsx)(y,{density:`compact`,children:e.text}),e.toolCalls&&e.toolCalls.length>0&&(0,x.jsx)(m,{calls:e.toolCalls}),e.customElement]},e.id))})})]})}},E={name:`Rapid Tool Calls`,render:()=>{let[e,t]=(0,b.useState)([{id:1,role:`user`,text:`Run the full test suite across all packages.`}]),[n,r]=(0,b.useState)(!1),a=(0,b.useRef)(void 0),s=(0,b.useRef)(0),c=(0,b.useCallback)(()=>{r(!0),s.current=0,a.current=setInterval(()=>{if(s.current++,s.current>10){clearInterval(a.current),r(!1);return}let e=Date.now()+s.current,n=[`read`,`bash`,`edit`,`ipython`,`show`],i=[`Button.test.tsx`,`yarn test --filter=Button`,`Button.tsx +8 -2`,`analyze_coverage()`,`coverage-report.html`],o=(s.current-1)%n.length;t(t=>[...t,{id:e,role:`assistant`,text:``,toolCalls:[{key:String(e),name:n[o]??`read`,target:i[o],status:`running`,node:`astryx`}]}]),setTimeout(()=>{t(t=>t.map(t=>t.id===e?{...t,toolCalls:[{key:String(e),name:n[o]??`read`,target:i[o],status:`complete`,duration:`${(Math.random()*3+.1).toFixed(1)}s`,node:`astryx`}]}:t))},300)},500)},[]),l=(0,b.useCallback)(()=>{clearInterval(a.current),r(!1)},[]),u=(0,b.useCallback)(()=>{clearInterval(a.current),r(!1),s.current=0,t([{id:1,role:`user`,text:`Run the full test suite across all packages.`}])},[]);return(0,x.jsxs)(`div`,{className:`x1dr59a3 x78zum5 xdt5ytf`,children:[(0,x.jsxs)(`div`,{className:`x78zum5 x167g77z xc7ga6q x4befzd x1a02dak x6s0dn4`,children:[(0,x.jsx)(i,{label:n?`Running...`:`Start Rapid Tool Calls`,variant:`primary`,size:`sm`,onClick:c,isDisabled:n}),(0,x.jsx)(i,{label:`Stop`,variant:`destructive`,size:`sm`,onClick:l,isDisabled:!n}),(0,x.jsx)(i,{label:`Reset`,variant:`ghost`,size:`sm`,onClick:u}),(0,x.jsx)(`div`,{className:`xvc5jky x78zum5 x6s0dn4 x17d4w8g`,children:(0,x.jsx)(o,{variant:n?`yellow`:`neutral`,label:n?`Tool call ${s.current}/10`:`${e.length-1} messages`})})]}),(0,x.jsx)(v,{composer:(0,x.jsx)(_,{onSubmit:()=>{},placeholder:`Watch scroll behavior...`}),children:(0,x.jsx)(h,{children:e.map(e=>(0,x.jsxs)(g,{sender:e.role,children:[e.text&&(0,x.jsx)(y,{density:`compact`,children:e.text}),e.toolCalls&&e.toolCalls.length>0&&(0,x.jsx)(m,{calls:e.toolCalls})]},e.id))})})]})}},D={name:`Mixed Stream + Tools`,render:()=>{let[e,t]=(0,b.useState)([{id:1,role:`user`,text:`Fix the focus ring and run the tests.`}]),[n,r]=(0,b.useState)(`idle`),a=(0,b.useRef)(void 0),s=(0,b.useCallback)(()=>{r(`streaming`);let e=Date.now(),n=`Let me look at the Button component's focus styles and fix the ring.

I can see the issue — the focus ring uses a hardcoded color instead of the theme token. Let me fix that and run the tests.`;t(t=>[...t,{id:e,role:`assistant`,text:``,isStreaming:!0}]);let i=0;a.current=setInterval(()=>{if(i+=3+Math.floor(Math.random()*4),i>=192){clearInterval(a.current),t(t=>t.map(t=>t.id===e?{...t,text:n,isStreaming:!1}:t)),r(`tools`),setTimeout(()=>{let e=Date.now();t(t=>[...t,{id:e,role:`assistant`,text:``,toolCalls:[{key:`1`,name:`edit`,target:`Button.tsx`,status:`running`,node:`astryx`}]}]),setTimeout(()=>{t(t=>t.map(t=>t.id===e?{...t,toolCalls:[{key:`1`,name:`edit`,target:`Button.tsx`,status:`complete`,duration:`92ms`,node:`astryx`,additions:4,deletions:2,resultDetail:(0,x.jsx)(c,{code:`- outline: 2px solid blue;
+ outline: 2px solid var(--color-ring-focus);
+ outline-offset: 2px;`,language:`diff`})}]}:t)),setTimeout(()=>{let e=Date.now();t(t=>[...t,{id:e,role:`assistant`,text:``,toolCalls:[{key:`2`,name:`bash`,target:`yarn test --filter Button`,status:`running`,node:`astryx`}]}]),setTimeout(()=>{t(t=>t.map(t=>t.id===e?{...t,toolCalls:[{key:`2`,name:`bash`,target:`yarn test --filter Button`,status:`complete`,duration:`3.8s`,node:`astryx`,resultDetail:(0,x.jsx)(c,{code:`✓ 24 tests passed
...
The fix ensures the ring adapts to different themes automatically — no more hardcoded blue.`;t(t=>[...t,{id:e,role:`assistant`,text:``,isStreaming:!0}]);let i=0;a.current=setInterval(()=>{if(i+=3+Math.floor(Math.random()*4),i>=202){clearInterval(a.current),t(t=>t.map(t=>t.id===e?{...t,text:n,isStreaming:!1}:t)),r(`done`);return}t(t=>t.map(t=>t.id===e?{...t,text:n.slice(0,i)}:t))},25)},600)},2e3)},800)},1500)},500);return}t(t=>t.map(t=>t.id===e?{...t,text:n.slice(0,i)}:t))},25)},[]),l=(0,b.useCallback)(()=>{clearInterval(a.current),r(`idle`),t([{id:1,role:`user`,text:`Fix the focus ring and run the tests.`}])},[]);return(0,x.jsxs)(`div`,{className:`x1dr59a3 x78zum5 xdt5ytf`,children:[(0,x.jsxs)(`div`,{className:`x78zum5 x167g77z xc7ga6q x4befzd x1a02dak x6s0dn4`,children:[(0,x.jsx)(i,{label:`Run Full Sequence`,variant:`primary`,size:`sm`,onClick:s,isDisabled:n!==`idle`&&n!==`done`}),(0,x.jsx)(i,{label:`Reset`,variant:`ghost`,size:`sm`,onClick:l}),(0,x.jsx)(`div`,{className:`xvc5jky x78zum5 x6s0dn4 x17d4w8g`,children:(0,x.jsx)(o,{variant:n===`streaming`?`green`:n===`tools`?`yellow`:`neutral`,label:n===`idle`?`Ready`:n===`streaming`?`Streaming text...`:n===`tools`?`Adding tool calls...`:`Complete`})})]}),(0,x.jsx)(v,{composer:(0,x.jsx)(_,{onSubmit:()=>{},placeholder:`Watch the transition from streaming → tool calls...`}),children:(0,x.jsx)(h,{children:e.map(e=>(0,x.jsxs)(g,{sender:e.role,children:[e.text&&(0,x.jsx)(y,{density:`compact`,children:e.text}),e.toolCalls&&e.toolCalls.length>0&&(0,x.jsx)(m,{calls:e.toolCalls})]},e.id))})})]})}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
