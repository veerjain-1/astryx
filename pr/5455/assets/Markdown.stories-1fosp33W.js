...
`),_={args:{children:h}},v={args:{children:h,density:`compact`}},y={name:`AI Response`,args:{children:g,density:`compact`,headingLevelStart:3}},b={name:`Shifted Headings (start at h3)`,args:{children:h,headingLevelStart:3}},x={name:`Inline Display`,render:()=>(0,p.jsxs)(`div`,{style:{maxWidth:680,display:`grid`,gap:16},children:[(0,p.jsx)(o,{type:`large`,display:`block`,children:(0,p.jsx)(d,{display:`inline`,children:"Use `value` with **controlled state** and [read the docs](https://example.com) without creating block wrappers."})}),(0,p.jsxs)(`div`,{style:{border:`1px solid #ddd`,borderRadius:8,padding:12,display:`grid`,gap:6},children:[(0,p.jsx)(o,{type:`body`,weight:`bold`,display:`block`,children:`Prop description`}),(0,p.jsx)(o,{type:`body`,color:`secondary`,display:`block`,children:(0,p.jsx)(d,{display:`inline`,children:'Accepts an action item `{label, onClick?, icon?}`, a divider `{type: "divider"}`, or a section `{type: "section", items: [...]}`.'})})]})]})},S={name:`Table`,args:{children:[`## Comparison Table`,``,`| Feature | React | Vue | Svelte |`,`|:--------|:-----:|:---:|-------:|`,`| Virtual DOM | Yes | Yes | No |`,`| Bundle Size | ~40KB | ~30KB | ~2KB |`,`| TypeScript | Native | Plugin | Native |`,`| Learning Curve | Medium | Easy | Easy |`].join(`
`)}},C={render:()=>{let e=g,[t,n]=(0,f.useState)(0),[r,a]=(0,f.useState)(!0),[o,s]=(0,f.useState)(0);return(0,f.useEffect)(()=>{if(!r)return;if(t>=e.length){a(!1);return}let i=Math.floor(Math.random()*8)+2,o=30+Math.random()*60,s=setTimeout(()=>{n(t=>Math.min(t+i,e.length))},o);return()=>clearTimeout(s)},[t,r,e]),(0,p.jsxs)(`div`,{children:[(0,p.jsxs)(`div`,{style:{marginBlockEnd:12,display:`flex`,gap:8,alignItems:`center`},children:[(0,p.jsx)(i,{label:`Replay`,variant:`secondary`,size:`sm`,onClick:(0,f.useCallback)(()=>{n(0),a(!0),s(e=>e+1)},[]),isDisabled:r}),(0,p.jsx)(`span`,{style:{fontSize:12,color:`var(--color-text-secondary)`},children:r?`Streaming... ${t}/${e.length}`:`Complete`})]}),(0,p.jsx)(d,{isStreaming:r,density:`compact`,headingLevelStart:3,children:e.slice(0,t)},o)]})}},w={name:`With Images`,render:()=>(0,p.jsx)(`div`,{style:{maxWidth:800},children:(0,p.jsx)(d,{children:`
